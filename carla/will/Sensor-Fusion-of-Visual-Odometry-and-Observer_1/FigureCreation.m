...
switch Route
    case (1)
        ...
        FIGUREPATH = "/MATLAB Drive/figures/";
    ...
    case (4)
        ...
        %FILEPATH = "/MATLAB Drive/Sensor-Fusion-of-Visual-Odometry-and-Observer/ExampleFileStructure/";
        FILEPATH = "/MATLAB Drive/Matlab/Sensor-Fusion-of-Visual-Odometry-and-Observer/ExampleFileStructure/";
        timestep = 0.00825;
...
%d = dir("/MATLAB Drive/**/KalmanFilter.m");
%addpath(genpath(d(1).folder))


%f = dir("/MATLAB Drive/**/SkipVisualOdometry*.mat");
